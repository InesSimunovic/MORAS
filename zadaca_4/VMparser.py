class Parser:
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            arg1 = l[2]
            if len(l) == 3 and int(arg1) >= 0 and arg1.isdigit():
            ...
            arg2 = l[2]
            if len(l) == 3 and int(arg2) >= 0 and arg2.isdigit():
                return "//" + " ".join(l) + "\n" + self._pop(l[1], l[2], n)
            else:
                self._flag = False
                Parser._error("Parser", n, "Undefined command");
    ...
    def _goto(self, lab, n):
        if lab in self.labels: 
            ...
            self._flag = False 
            Parser._error("Goto", n, "Jumping to undefined label.")
            return ""
    ...
    def _ifgoto(self, lab, n):
        if lab in self.labels: 
            ...
            self._flag = False
            Parser._error("If-goto", n, "Jumping to undefined label.")
            return ""
